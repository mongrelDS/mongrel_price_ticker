    ...
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                ...
                return None # Or you could re-raise the exception: raise last_exception

if __name__ == '__main__' and db_password:

    # --- Recommended Engine Creation ---
